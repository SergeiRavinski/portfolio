...
export default function LinkComponent({ url, title, isDashed }: LinkComponentProps) {
	const arrowStyles =
	...
	return (
		<Link href={url} target="_blank" className={linkStyles}>
			<h2 className="text-[0.7rem] font-medium uppercase will-change-auto md:text-[0.8rem]">
